...
// Color darkGreyColor = new Color(0xFF1f1f1f);
// Color lightGreyColor = new Color(0xFF6b6b6b);
Color backgroundColor = new Color(0xFFf0f0f0);
Color whiteFontColor = new Color(0xFFfafafa);
Color darkFontColor = new Color(0xFF424242);
const Color redTheme = const Color(0xFFb00000);
...
TextStyle redPopUpButton = new TextStyle(fontFamily: defaultFont, fontSize: 16, color: Colors.red, fontWeight: FontWeight.w800);
TextStyle greyPopUpButton = new TextStyle(fontFamily: defaultFont, fontSize: 16, color: darkFontColor, fontWeight: FontWeight.w400);
TextStyle popUpTitle = new TextStyle(fontFamily: defaultFont, fontSize: 23, color: darkFontColor);
TextStyle popUpDescription = new TextStyle(fontFamily: defaultFont, fontSize: 17, color: darkFontColor);
TextStyle widgetTitle = new TextStyle(fontFamily: defaultFont, fontSize: 33, color: darkFontColor, fontWeight: FontWeight.w600);
...
TextStyle basicBlue = TextStyle(fontFamily: defaultFont, fontSize: 19, color: redTheme, fontWeight: FontWeight.w400);
